...
$fec1[11]="12";
 ...
 for($i=1;$i<=12;$i++){
     ...
     if($q==1 or $q==2){
     if($i<12){
         $text=$text." SUM(IF(MONTH(fecha_factura)='$i' and YEAR(fecha_factura)=$anio and ven_com=1 and estado_factura<=3 and activo=1 and facturas.tienda$tienda,total_venta-obs,0)) AS '$fec[$j]',";
         $text=$text." SUM(IF(MONTH(fecha_factura)='$i' and YEAR(fecha_factura)=$anio and ven_com=2 and estado_factura<=3 and activo=1 and facturas.tienda$tienda,total_venta-obs,0)) AS '$fec1[$j]',";
     ...
     if($q==3){
     if($i<12){
         $text=$text." SUM(IF(MONTH(fecha)='$i' and YEAR(fecha)=$anio and tipo_doc<=3 and ven_com=1 and activo=1 and detalle_factura.tienda$tienda,cantidad*precio_venta-mone,0)) AS '$fec[$j]',";
         $text=$text." SUM(IF(MONTH(fecha)='$i' and YEAR(fecha)=$anio and tipo_doc<=3 and ven_com=2 and activo=1 and detalle_factura.tienda$tienda,cantidad*precio_venta-mone,0)) AS '$fec1[$j]',";
     }else{
         $text=$text." SUM(IF(MONTH(fecha)='$i' and YEAR(fecha)=$anio and tipo_doc<=3 and ven_com=1 and activo=1 and detalle_factura.tienda$tienda,cantidad*precio_venta-mone,0)) AS '$fec[$j]',";
         $text=$text." SUM(IF(MONTH(fecha)='$i' and YEAR(fecha)=$anio and tipo_doc<=3 and ven_com=2 and activo=1 and detalle_factura.tienda$tienda,cantidad*precio_venta-mone,0)) AS '$fec1[$j]'";
     }
