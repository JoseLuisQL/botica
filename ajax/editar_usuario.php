          ...
          )
         {
            ...
            $query_update = mysqli_query($con,$sql);
                    if ($query_update) {
                        ...
                        $sql1 = "UPDATE clientes SET nombre_cliente='".$firstname."',email_cliente='".$user_email."', documento='".$dni."', dni='".$dni."', direccion_cliente='".$domicilio."', telefono_cliente='".$telefono."'
