...
<?php
	...
	if($action == 'ajax'){
		...
		$sWhere = "";
		$sWhere.=" WHERE facturas.aceptado='planilla' and facturas.tienda=$tienda1 and facturas.id_cliente=clientes.id_cliente and facturas.id_vendedor=users.user_id and facturas.servicio=2";
		if ( $_GET['q'] != "" )
		{
		...
		$sWhere.= " and  (DATE_FORMAT(fecha_factura, '%Y-%m-%d')<='$q3')";
                ...
                if ( $_GET['q4'] != "" )
		{
		$sWhere.= " and  facturas.id_cliente='$q4'";
		}
		$sWhere.=" and facturas.ven_com=6 order by facturas.id_factura desc";
		...
		if ($numrows>0){
			...
			<div class="table-responsive">
			  <table class="table" style="color:black;">
				...
				?>
                                        <tr><td colspan="5"></td><td>Total:</td><td class='text-right'><?php echo $mon;?> <?php echo $sum;?></td><td></td><td></td><td></td></tr>
