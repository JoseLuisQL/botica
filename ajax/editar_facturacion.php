	...
	$sumador_total+=$precio_total_r;//Sumador
		...
		<tr style="background:white;">
			<td class='text-center' style="background:white;"><?php echo $codigo_producto;?></td>
                        <td class='text-center' style="background:white;"><textarea id="cantidad_tmp-<?php echo $id_tmp;?>" name="cantidad_tmp-<?php echo $id_tmp;?>" class="monto input" style="background:#A9D0F5;" ><?php echo $cantidad;?></textarea></td>
			<td style="background:white;"><?php echo $nombre_producto;?></td>
                        <td class='text-right' style="background:white;"><textarea id="precio_tmp-<?php echo $id_tmp;?>" name="precio_tmp-<?php echo $id_tmp;?>" class="monto input" style="background:#A9D0F5;" ><?php echo $precio_venta_f;?></textarea></td>
                        <td class='text-right' style="background:white;"><input class="monto total" type="text" readonly value="<?php echo $precio_total_f;?>" style="width:100px;height:40px;"></td>
...
<tr style="background:white;">
	...
	<td class='text-right' style="background:white;"><input type="text" class="monto1" value="<?php echo number_format($total_factura,2);?>" style="width:100px;height:40px;"></td>
	<td></td>
</tr>
<tr style="background:white;">
	<td class='text-right' colspan=4 style="background:white;">IGV (<?php echo 18?>)% </td>
	<td class='text-right' style="background:white;"><input type="text" class="monto2" value="<?php echo number_format($total_iva,2);?>" style="width:100px;height:40px;"></td>
	<td></td>
</tr>
<?php
        }
...
<tr style="background:white;">
	...
	<td class='text-right' style="background:white;"><input class="monto totales" type="text" value="<?php echo number_format($subtotal,2);?>" style="width:100px;height:40px;"></td>
	<td></td>
</tr>
</table>
</body>
