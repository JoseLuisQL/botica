               ...
               <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="x_panel" style="background:<?php echo COLOR;?>;">
                        <form  style="color:black;" name="myForm" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="consulta111.php">
                        ...
                        <select style="width:100%;" class="select2_single form-control" name="user_id" required="required" tabindex="-1">
                ...
                <div class="table-responsive">
                  <table id="example"  style="width:100%;color:black;">
                   ...
                   ?>
                    ...
                    $sql="SELECT * FROM  detalle_factura,products,users,und where products.valor2>0 and products.und_pro=und.id_und and detalle_factura.id_vendedor=users.user_id and detalle_factura.id_producto=products.id_producto and detalle_factura.numero_factura=$numero_factura and detalle_factura.folio='$folio' and detalle_factura.activo=1 and detalle_factura.id_cliente=$id_cliente and detalle_factura.tipo_doc=$estado_factura and detalle_factura.tienda=$tienda";
					...
					<td><?php echo moneda; ?><?php echo number_format($venta1, 2, '.', ''); ?></td>
                                        <td><?php echo moneda; ?><?php echo number_format($cantidad*$venta1, 2, '.', ''); ?></td>
                                        
                                        <td align="right"><?php echo moneda; ?><?php echo round($comision,2); ?></td>
			...
			?>
               ...
               <tr>
					...
					<td></td>
                                        ...
                                        <td>Total</td>
                                        <td align="right"><strong><?php echo moneda; ?><?php echo round($suma1,2); ?></strong></td>
                                </tr>      
