...
$suma1= mysqli_query($con, "SELECT SUM(total_venta-obs) AS total1 FROM facturas  where condiciones=1 and (estado_factura<=3 or estado_factura=5) and activo=1 and ven_com=1 and tienda=$tienda1 and  (DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fecha1' )");
$row1= mysqli_fetch_array($suma1);
$total1 = $row1['total1'];
$suma4= mysqli_query($con, "SELECT SUM(total_venta-obs) AS total4 FROM facturas  where  condiciones=1 and activo=1 and (ven_com=5 or ven_com=3) and tienda=$tienda1 and  (DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fecha1' )");
$row4= mysqli_fetch_array($suma4);
$total4 = $row4['total4'];
                                                    
$suma2= mysqli_query($con, "SELECT SUM(total_venta-obs) AS total2 FROM facturas  where condiciones=1 and estado_factura=6 and motivo<>'01' and motivo<>'02' and activo=1 and ven_com=1 and tienda=$tienda1 and  (DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fecha1' )");
$row2= mysqli_fetch_array($suma2);
$total2 = $row2['total2'];
                                                    
$suma3= mysqli_query($con, "SELECT SUM(total_venta-obs) AS total3 FROM facturas  where condiciones=1 and activo=1 and (ven_com=2 or ven_com=4) and tienda=$tienda1 and  (DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fecha1' )");
$row3= mysqli_fetch_array($suma3);
$total3 = $row3['total3'];
                                                    
$suma5= mysqli_query($con, "SELECT SUM(total_venta-obs) AS total5 FROM facturas  where condiciones=1 and activo=1 and ven_com=6 and tienda=$tienda1 and  (DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fecha1' )");
...
<body class="nav-md">
          ...
          <div class="row">
              ...
              <div class="x_panel">
                <div class="x_title">
                    ...
                    <p style="color:#00a5d9;"> <strong>Grafica de barras Ventas y Compras (Últimos 10 días)</strong></p>
              ...
              <div class="x_panel">
                <div class="x_title">
                    ...
                    <p style="color:#00a5d9;"> <strong>Grafica de barras Entradas y Salidas (Últimos 10 días)</strong></p>
              ...
              <div class="x_panel">
                <div class="x_title">
                    ...
                    <p style="color:#00a5d9;"> <strong>Grafica de barras Ventas y Compras (Últimos Meses)</strong></p>
              ...
              <div class="x_panel">
                <div class="x_title">
                    ...
                    <p style="color:#00a5d9;"> <strong>Grafica de barras Entradas y Salidas (Últimos Meses)</strong></p>
  ...
  <script>
    ...
    Morris.Bar({
        ...
        data: day_data,
        xkey: 'period',
        barColors: ['#f58498', '#00c2ff', '#ACADAC', '#00c2ff'],
    ...
    Morris.Bar({
        ...
        data: day_data,
        xkey: 'period',
        barColors: ['#00c2ff', '#f58498', '#ACADAC', '#f58498'],
