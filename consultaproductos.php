                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                           <input  type="search" style="color:black;font-size:10pt; font-family:Verdana;" class="form-control" id="nombre_producto" name="nom_pro" value="<?php echo $nom_pro;?>" placeholder="Nombre del producto" >
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                         <input  type="text"  class="form-control" id="cod_pro" name="cod_pro" value="<?php echo $codigo_producto;?>" placeholder="Codigo del producto" >
   ...
   if($valor3['id_categoria']==$row["cat_pro"]){
       $cat1=$valor3['nom_cat'];
                       ...
                       <td class=" "><?php echo $cat1;?></td>
                        <td class=" "><?php echo$row["codigo_producto"];?></td>
                        
                        <td class=" "><?php 
                        $cadena=$row["nombre_producto"];
                        ...
                        <td class=" "><form id="ficha"><textarea readonly="" <?php echo $read;?> style="width:90px;height:40px;" text-align="center" id="<?php echo $row["id_producto"];?>" name="<?php echo $row["id_producto"];?>" ><?php echo $inv;?></textarea></form></td>
                         <?php
                           }else{
