...
//$sql="select * from products ORDER BY  `products`.`id_producto` DESC LIMIT 0 , 100";
  ...
  <div class="table-responsive" >
         <h2><font color="black"> Resumen de Entradas y Salidas</font> </h2>            
...
$sql="select * from facturas,clientes where facturas.turno='$turno' and facturas.activo=1 and facturas.id_vendedor=$id_vendedor and facturas.tienda=$tienda and clientes.id_cliente=facturas.id_cliente and DATE_FORMAT(fecha_factura, '%d-%m-%Y')='$a'"; 
    ...
    if($condiciones<>4){
      ...
      if($efectivo1+$efectivo2>0){
        ...
        <tr id="valor1">
            ...
            <td class=" "><?php print"$monedero";?></td>
