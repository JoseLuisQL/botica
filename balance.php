...
for($i=$f1;$i<=$f2;$i++){
    $sql1="select * from facturas where activo=1 and tienda>=$tienda1 and tienda<=$tienda2 and estado_factura>0 and DATE_FORMAT(fecha_factura, '%Y-%m-%d')>='$fecha1' and DATE_FORMAT(fecha_factura, '%Y-%m-%d')<='$fecha2'"; 
...
while($row1= mysqli_fetch_array($rs1)){
    ...
    $venta1=$row1['total_venta']-$row1['obs'];
    //$mone=$row1['mone'];
  ...
  <script>
    ...
    Morris.Bar({
       ...
       function imprimir(id_factura,tienda){
            ...
            window.open('utilidades.php?f='+id_factura+'&tienda='+tienda, "Pagos", "width=900, height=1000")
