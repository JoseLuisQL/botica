...
$suma2= mysqli_query($con, "SELECT SUM(total_venta-obs) AS total2 FROM facturas  where condiciones=1 and estado_factura=6 and activo=1 and ven_com=1 and tienda=$tienda1 and  (DATE_FORMAT(fecha_factura, '%Y-%m-%d')='$fecha1' )");
...
if($tipo==2 || $tipo==4 || $tipo==6 || ($tipo==1 and $estado==6)){
    ...
    if($condiciones>0){
        $salida=$row1['total_venta']-$row1['obs'];
        if($tipo==2){
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table >
                      ...
                      <tr style="background: <?php echo tablas;?>;color:white;font-size:18px;">
                          <?php
                          date_default_timezone_set('America/Lima');
                        ...
                        <td style="width:10%;text-align:right">
                         ...
                         if($tipo2=="CERRADO"){
                            ...
                            <button disabled type='button' onclick="obtener_datos('<?php echo $id_caja;?>');" class="btn btn-info" data-toggle="modal" data-target="#myModal2"><span class="glyphicon glyphicon-plus" ></span> Cerrar Caja</button>
                            <?php 
                         }
                         ?>
