...
while($row=mysqli_fetch_array($rs)){
 ...
 <?php   
    ...
    $sql="SELECT nombre_cliente,
SUM(if(YEAR(fecha_factura)=2019 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes1,
SUM(if(YEAR(fecha_factura)=2020 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes2,
SUM(if(YEAR(fecha_factura)=2021 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes3,
SUM(if(YEAR(fecha_factura)=2022 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes4,
SUM(if(YEAR(fecha_factura)=2023 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes5,
SUM(if(YEAR(fecha_factura)=2024 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes6,
SUM(if(YEAR(fecha_factura)=2025 and ven_com=1 and activo=1 and estado_factura<=3 and facturas.tienda=$tienda,total_venta,0)) AS mes7
