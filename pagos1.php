...
$a=recoge1('a');
$fecha1=recoge1('fecha1');
$fecha2=recoge1('fecha2');
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
          ...
          <div class="row">
              <div class="x_panel" style="background:#81F79F;color:black;">
               <div class="panel panel-info">
		<div class="panel-heading">
		   
                    <h2>Buscar Pagos entre dos fechas:</h2>
		</div>        
                </div> 
                  <form  data-parsley-validate class="form-horizontal form-label-left" method="GET" action="pagos1.php">
...
//$sql="select * from products ORDER BY  `products`.`id_producto` DESC LIMIT 0 , 100";
            ...
            <div class="table-responsive">
                  ...
                  <table id="example" class="display nowrap" style="width:100%;color:black;">
                    ...
                    <tbody>  
<?php   
$sql="select * from facturas, clientes, users where facturas.id_cliente=$a and facturas.id_cliente=clientes.id_cliente and facturas.id_vendedor=users.user_id and facturas.ven_com=4 and facturas.activo=1 and DATE_FORMAT(facturas.fecha_factura, '%Y-%m-%d')>='$fecha1' and  DATE_FORMAT(facturas.fecha_factura, '%Y-%m-%d')<='$fecha2'"; 
$s=1;
