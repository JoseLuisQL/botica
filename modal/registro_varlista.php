	...
	$tienda1=$_SESSION['tienda'];
        ...
        <div class="modal fade" id="nuevoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			...
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 style="color:black;" class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i><font color="black"> Agregar nueva variable a empleado</font></h4>
		  </div>
		  <div class="modal-body">
			<form style="color:black;" class="form-horizontal" method="post" id="guardar_varlista" name="guardar_varlista" >
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="date" autocomplete="off" class="form-control" name="fecha_entrada" id="fecha_entrada" >
				</div>
			</div>
                 	<div class="form-group">
