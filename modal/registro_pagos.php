	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content" style="background: white;">
		  ...
		  <div class="modal-body">
			<form style="color:black;" style="color:black;" class="form-horizontal" method="post" id="nuevo_pagos" name="nuevo_pagos">
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				<label for="mod_factura" class="col-sm-3 control-label">Factura</label>
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" autocomplete="off" class="form-control" id="mod_factura" name="mod_factura"  disabled>
