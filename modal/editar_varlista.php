	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content" style="background:white;">
			...
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 style="color:black;" class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i><font color="black"> Editar</font></h4>
		  </div>
		  <div class="modal-body">
			<form style="color:black;" class="form-horizontal" method="post" id="editar_varlista" name="editar_varlista" >
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="date" autocomplete="off" class="form-control" name="mod_fecha_entrada" id="mod_fecha_entrada" required>
				</div>
			</div>
                        <div class="form-group">
