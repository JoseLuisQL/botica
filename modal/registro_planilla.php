		...
		<div class="modal-content" style="background: white;"> 
		  <div class="modal-header" style="background: #58FAAC;color:black;">
			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 style="color:black;" class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i><font color="black"> Agregar nueva pago de trabajador</font></h4>
		  </div>
		  <div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<input autocomplete="off" type="text" class="form-control" id="nombre" name="nombre" placeholder="Breve descripción de la operación" required>
				 ...
				 <select class="form-control" id="cliente" name="cliente" required>
					<option value="1">-- Trabajador  --</option>
                        <?php
                            ...
                            $sql2="select * from clientes where tipo1=0 ORDER BY  `clientes`.`nombre_cliente` ASC ";
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="number" min="0.01"  step="0.01" class="form-control" id="pago" name="pago" placeholder="Cantidad a pagar o cobrar en S/" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8">
				</div>
			  </div>
                         <div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				 <select class="form-control" id="estado_factura" name="estado_factura" required>
                        ...
                        <?php
                        $sql2="select * from comprobante_pago where id_comprobante=20";
                        $i=0;
                        $rs1=mysqli_query($con,$sql2);
                        while($row3=mysqli_fetch_array($rs1)){
                        ...
                        <div class="form-group">
                            <?php
                                    $count_query   = mysqli_query($con, "SELECT count(*) AS numrows FROM facturas where aceptado='planilla'");    
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input type="text" readonly value="<?php echo $numrows;?>" autocomplete="off" class="form-control" id="numero_factura" name="numero_factura" placeholder="Nro del documento" required>
				</div>
			</div>
