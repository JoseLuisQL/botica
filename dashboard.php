          ...
          <div class="row top_tiles">
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="icon"><i class="fa fa-building"></i>
                    ...
                    <h3><font color="white"><strong>Total de ventas</strong></font></h3>
            ...
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats" STYLE=" background-color:#00c2ff">
                ...
                <h3><font color="white"><strong>Total de compras</strong></font></h3>
                <p sTYLE="color:black"><strong>Fecha: <?php echo date("d-m-Y");?></strong></p>
              </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats" STYLE=" background-color:#00c2ff">
                ...
                <h3><font color="white"><strong>Total de entradas</strong></font></h3>
                <p sTYLE="color:black"><strong>Fecha: <?php echo date("d-m-Y");?></strong></p>
              </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats" STYLE=" background-color:#00c2ff">
                ...
                <h3><font color="white"><strong>Total de salidas</strong></font></h3>
                <p sTYLE="color:black"><strong>Fecha: <?php echo date("d-m-Y");?></strong></p>
              </div>
            </div>
          </div>
                ...
                <style>  
                    ...
                    <i class="fas fa-file-invoice"></i>
                        <span class="tex-icono">
                            Crear factura de POS
                        </span>
                    </button>

                    <button id="myButton2" type="button" class="btn-animado animacion-cuatro color-instagram">
                    ...
                    <button id="myButton3" type="button" class="btn-animado animacion-cuatro color-instagram">
                    ...
                    <button id="myButton4" type="button" class="btn-animado animacion-cuatro color-instagram">
                    ...
                    <button id="myButton5" type="button" class="btn-animado animacion-cuatro color-instagram">
                    ...
                    <button id="myButton6" type="button" class="btn-animado animacion-cuatro color-instagram">
