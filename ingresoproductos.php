          ...
          if($mensaje<>"")
             ...
             <?php 
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  ...
				  <input style="background:<?php echo COLOR1;?>;" type="text"  autocomplete="off" class="form-control" id="codigo" name="codigo" placeholder="El código debe ser corto y numerico" required  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php echo $ultimo;?>';}">
				</div>
			</div>
          
                        <div class="form-group">
                                <label for="nombre"  class="col-sm-4 control-label">Nombre del producto: </label>
				<div class="col-md-8 col-sm-8 col-xs-12">
			...
			<div class="form-group">
                                <label for="nombresanitario"  class="col-sm-4 control-label">Registro Sanitario</label>
				                        <div class="col-md-8 col-sm-8 col-xs-12">
                                   <input   type="search" style="color:black;font-size:10pt; font-family:Verdana;" class="form-control" id="nombre_sanitario" name="nombresanitario"  placeholder="Registro Sanitario" >
                                </div>
                        </div>
			  ...
			  <div class="form-group">
                              <label for="precio" class="col-sm-1 control-label" style="width:9%;padding-left:0px;"> Costo</label>
				...
				<label for="precio" class="col-sm-1 control-label" style="width:8%;padding-left:0px;">Precio</label>
				<div class="col-md-2 col-sm-2 col-xs-12" style="width:24%;">
				  <input style="background:<?php echo COLOR1;?>;"  type="number" min="0.01" step="0.01"  autocomplete="off" class="form-control" name="precio" id="precio" name="Precio por unidad"  placeholder="Precio" required>
                                ...
                                <div class="form-group">
                               <label for="precio" class="col-sm-2 control-label" style="width:12%;padding-left:0px;">Stock</label>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  ...
				  <input type="hidden"  class="form-control" id="precio2" name="precio2"  value="0">
                           ...
                           <div style="background:#045FB4;padding:2px;color:white;font-weight:bold;">Blister/docena:</div>
                           <div class="form-group">
                               <label for="precio" class="col-sm-3 control-label" style="width:9%;padding-left:0px;"> Costo </label>
				...
				<label for="precio" class="col-sm-2 control-label" style="width:8%;padding-left:0px;">Precio</label>
				<div class="col-md-3 col-sm-3 col-xs-12" style="width:24%;">
				  <input   type="number" min="0.01" step="0.01"  autocomplete="off" class="form-control" name="p2" id="p2"  placeholder="Precio blister" >
				</div>
                                
                                    <input   type="hidden"  value="0" class="form-control" id="s2" name="s2" >
				
                                <label for="precio" class="col-sm-2 control-label" style="width:12%;padding-left:0px;">Contiene</label>
				<div class="col-md-2 col-sm-2 col-xs-12" style="width:23%;">
                                ...
                                <label for="cat_pro" class="col-sm-3 control-label" style="width:9%;padding-left:0px;">Tipo</label>
				<div class="col-md-7 col-sm-7 col-xs-12">
				<select   class="form-control" id="tipo7" name="tipo7" required>
				...
				<div class="col-md-3 col-sm-3 col-xs-12" style="width:24%;">
				  <input   type="number" min="0.01" step="0.01"  autocomplete="off" class="form-control" name="p3" id="p3"   placeholder="Precio Caja" >
                                    ...
                                    <input   type="hidden" value="0"  id="s3" name="s3" >
