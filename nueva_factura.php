...
while ($row2=mysqli_fetch_array($sql2))
{
    ...
    $cantidad=$row2['cantidad'];
    $id=$row2['id_producto'];
    $insert_tmp=mysqli_query($con, "INSERT INTO tmp (id_producto,cantidad_tmp,precio_tmp,session_id,tienda,fecha1,fecha2,lote) VALUES ('$id','$cantidad','$precio_venta','$session_id','1000','0000-00-00','0000-00-00','')");
}
...
$mon=round($row3['users'],2);
$mon1=round($row3['users']*$conver,2);
        ...
        <div class="container" >
                    ...
                    <?php 
                      //include("modal/buscar_productos.php");
                                        include("modal/editar_ruta1.php");
                    ...
                    <div class="tab" style="display:none;">
                                              <button class="tablinks active" id="defaultOpen" onclick="openCity(event, 'Venta')">Venta </button>
                                              
                                              <button class="tablinks" id="defaultOpen" onclick="openCity(event, 'Productos')">Productos </button>
                                              
                        
                    </div>
                    
                    <div id="Productos" class="col-md-7 col-sm-7 col-xs-12" style=" background: white;padding-left:3px; ">
                            <table class="table" style="margin:1px;padding:10px;width:100%;">
                                <tr style="background:#E6E6E6;color:black;">
                                    <td style="width:70%;padding:2px;">    
                                        <input type="search" style="height:25px;" autocomplete="off" class="busca" id="caja_busqueda" name="clave" placeholder="Buscar nombre o codigo producto"/><br />
                            ...
                            <button id="myButton1" type="button" class="btn-animado animacion-cuatro color-instagram">
                            ...
                            <script type="text/javascript">
                              document.getElementById("myButton1").onclick = function () {
                                  location.href = "ingresoproductos.php";
                              };
                    ...
                    <div id="Venta" class="col-md-5 col-sm-5 col-xs-12" style="background: <?php echo COLOR;?>;border:2px solid rgb(0, 191, 255);padding: 2px; display: block;" >
                        
                        <div style="background:#01A9DB;padding:5px;margin:5px;border-radius: 7px;">
                            <font color="white" size="3"><strong>VENTAS:</strong></font><font color="white">   LLenar campos obligatorios</font> <font style="background-color:<?php echo COLOR1;?>;color:white; "> &nbsp;&nbsp;&nbsp;&nbsp;</font>                          
                        </div> 
                       
                    <form class="form-horizontal" role="form" id="datos_factura" action="facturas.php" method="get">
                       
                         <div class="col-md-12" style="padding:2px;width:100%;">
                          <div>
                            ...
                            <span class="glyphicon glyphicon-search"></span> + Descripción
                            </button>
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12" style="padding:2px;width:40%;">
                                Doc cliente
                                     							                       
                                            <input type="search" autocomplete="off" class="form-control" style="background-color: <?php echo COLOR1;?>;" name="doc1" id="doc1"  placeholder="<?php echo $dato;?>"  value="<?php echo $documento;?>" value = '11111111' required>
                            </div>
                                                        
                            
                            <div  class="col-md-4 col-sm-24 col-xs-12" style="padding:2px;width:40%;">
                                                        Tipo Documento
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12" style="padding:2px;width:20%;">
                                      <input  type="button" class="btn btn-success" style=" margin-top: 15px;" id="btn-ingresar" value="Buscar" />
                            </div>
                                  
                        </div>
                        <div class="form-group row" >
                            <div class="col-md-10 col-sm-10 col-xs-12" style="padding:2px;width:85%;">
                                Cliente
                                <input   type="search" minlength="10"  class="form-control" style="background-color: <?php echo COLOR1;?>;" name="nombre_cliente" id="nombre_cliente" placeholder="Nombre del cliente"  value="<?php echo $nombre;?>"   required>
					 
                                <input id="id_cliente" type='hidden'>	
                            </div>
                            <div class="col-md-2 col-sm-2 col-xs-12" style="padding:2px;width:15%;">
                            <a class="btn btn-success" style='cursor: pointer;' onClick="muestra_oculta('contenido')" title="" class="boton_mostrar">Ver</a>
                            </div>
                        </div>
                        <div id="contenido">
                        <div class="form-group row" >
                            <div class="col-md-12 col-sm-12 col-xs-12" style="padding:2px;width:100%;">
                                                            Dirección del cliente:
								<input  type="text" autocomplete="off"  class="form-control" id="direccion_cliente" placeholder="Dirección del cliente" value="<?php echo $direccion;?>">
                            </div>
                         </div>
                        <div class="form-group row" >    
                            <div class="col-md-6 col-sm6 col-xs-12" style="padding:2px;width:50%;">
                                                            Teléfono
								<input  type="text" autocomplete="off" class="form-control" id="tel1" value="<?php echo $telefono;?>" placeholder="Teléfono" >
                            </div>
					
                            <div class="col-md-6 col-sm-6 col-xs-12" style="padding:2px;width:50%;">
                                                            Email
			...
			<div class="form-group row">
							...
							<?php date_default_timezone_set('America/Lima');?>
                                                ...
                                                <div class="form-group row">
                                                        <div class="col-md-4 col-sm-4 col-xs-12" style="padding:2px;width:30%;">
                                                            Monedero Puntos:
                                     							                       
                                                            <input type="text" autocomplete="off" class="form-control" name="mone1" id="mone1" readonly value="<?php echo $mon1;?>" style="background:#40a0ff ;color:white;text-align:center;">
							</div>
                                                    
                                                        <div class="col-md-4 col-sm-4 col-xs-12" style="padding:2px;width:30%;">
                                                            Monedero:<?php echo moneda;?>
                                     							                       
                                                            <input type="text" autocomplete="off" class="form-control" name="mone" id="mone" readonly value="<?php echo $mon;?>" style="background:#40a0ff ;color:white;text-align:center;">
							</div>
                                                        <div class="col-md-4 col-sm-4 col-xs-12" style="padding:2px;width:40%;">
                                                            Paga Mon:
                                     							                       
                                                            <input style="color:black;"  type="text" pattern="^\d*.?\d*$" autocomplete="off" class="form-control" name="monedero" id="monedero" style="background:white ;color:green;text-align:center;">
                                                        </div>
									 ...
									 <?php
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12" style="padding:2px;width:50%;">
                                            Nro Dias Crédito
                                            <input  disabled style="background-color: <?php echo COLOR1;?>;" autocomplete="off" type="text" pattern="^[0-9]{0,12}([,][0-9]{2,2})?$" value="0" class="form-control" id="dias" name="dias" placeholder="Número de días de crédito">
                                            </div>
                                        ...
                                        <input style="background-color: #b1f5b1;color:black;text-align:center;height:50px;font-size: 18pt;" autocomplete="off" type="search" onchange="sumar2();" class="form-control" id="pagado" placeholder="Paga con:">                                

                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12" style="padding:2px;width:50%;">
                                        Vuelto
                                        
                                        <div id="vuelto" style="background:#A9E2F3;color:black;text-align:center;height:50px;padding:8px;font-size:18pt;" class="form-control"></div>
		  ...
		  var condiciones = $("#condiciones").val();
		   ...
		   var fecha = $("#fecha").val();
                    ...
                    var direccion = $("#direccion_cliente").val();
                     var direccion = encodeURIComponent(direccion);
                    var des = $("#des").val();
                    var tip = $("#tip").val();
...
function obtener_datos1(id,id1){
			//var id= $("#id").val();
			...
			$("#loader1").fadeIn('slow');
			$.ajax({
				url:'./ajax/datos_ruta1.php?action=ajax&page='+1+'&q='+id+'&q1='+id1,
				 beforeSend: function(objeto){
