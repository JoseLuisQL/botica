			...
			?>
				...
				<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							<label for="q" class="col-md-3 control-label">Código, nombre, laboratorio,componente</label>
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Código ,nombre, laboratorio,componente" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
