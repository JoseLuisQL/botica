           ...
           <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-barcode"></i> Productos y Servicios<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="kardex.php">Kardex de Productos</a>
                     ...
                     <li><a href="kardex2.php">Entradas y Salidas Porductos</a>
                     <li><a href="nueva_entsal.php">Guia Entradas/Salidas<font color="red"> Nuevo</font></a>
                    </li>
                    <li><a href="listaguias.php">Lista Guias<font color="red"> Nuevo</font></a>
                    </li>     
                    </li>
                ...
                <li><a><i class="fa fa-shopping-cart"></i> Compras <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="compras-eliminadas.php">Compras Eliminadas <font color="red">(Nuevo)</font></a></li>
              ...
              <li><a><i class="fa fa-building"></i> Balance y otros <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                     <li><a href="consulta14.php">Analisis Rentabilidad <font color="red"> Nuevo</font></a></li>
                ...
                <li><a><i class="fa fa-line-chart"></i> Reporte de Ventas<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="consulta11.php">Ventas por vendedor diario</a>
                     ...
                     <li><a href="consulta111.php">Comision vendedores</a>
                 ...
                 <li><a><i class="fa fa-calculator"></i> Contabilidad y Otros<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                      ...
                      <li><a href="productos1.php">Valorizacion Productos</a></li>
