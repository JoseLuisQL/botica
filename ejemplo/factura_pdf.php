...
while ($row=mysqli_fetch_array($sql))
	...
	$sumador_total+=$precio_total_r;//Sumador
        ...
        if($id_producto>0){
            ...
            $valor2=$row3['valor2'];
            $valor3=$row3['valor3'];
            //$mon3=$row3['mon']*$cantidad;
            $mon3=0.01*$cantidad*$precio_venta;
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_factura VALUES (NULL,'$id_cliente','$id_vendedor','$numero_factura','$des','$id_producto','$cantidad','$precio_venta_r','$c','$ddd','1','$date_added','$costo','$tipo','$d','$moneda1','$folio','$valor2','$valor3','$mon3')");
