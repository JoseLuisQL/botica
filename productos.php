...
while (($datos =fgetcsv($productos,2000,",")) !== FALSE )//Leo linea por linea del archivo hasta un maximo de 1000 caracteres por linea leida usando coma(,) como delimitador
{
   ...
   /*--------------- AGREGADO REGISTRO_SANITARIO --------------*/
    ...
    $linea[]=array('codigo_producto'=>$datos[0],'nombre_producto'=>$datos[1],'registro_sanitario'=>$datos[2],'c1'=>$datos[3],'c2'=>$datos[4],'c3'=>$datos[5],'a1'=>$datos[6],'a2'=>$datos[7],'a3'=>$datos[8],'marca'=>$datos[9],'modelo'=>$datos[10],'color'=>$datos[11],'proveedor'=>$datos[12],'b1'=>$datos[13],'b2'=>$datos[14],'b3'=>$datos[15],'b4'=>$datos[16],'b5'=>$datos[17],'b6'=>$datos[18],'b7'=>$datos[19],'min'=>$datos[20],'barras'=>$datos[21],'und'=>$datos[22],'blister'=>$datos[23],'caja'=>$datos[24],'bli'=>$datos[25],'fecha'=>$datos[26],'lote'=>$datos[27]);//Arreglo Bidimensional para guardar los datos de cada linea leida del archivo
...
fclose ($productos);//Cierra el archivo
	...
	/*--------------- AGREGADO REGISTRO_SANITARIO --------------*/ 
        $registro_sanitario=$value["registro_sanitario"];
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
	...
	function obtener_datos(id){
			...
			/*--------------- AGREGADO ARRAY REGISTRO_SANITARIO --------------*/
     			var registro_sanitario = $("#registro_sanitario"+id).val();



			var pagi = $("#pagi"+id).val();
			...
			/*--------------- AGREGADO REGISTRO_SANITARIO --------------*/
      			...
      			$("#mod_registrosanitario").val(registro_sanitario);
