               ...
               <div class="row" style="color:black;">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <input type="hidden" name="d" value="1">
                        <button id="send" type="submit" name="enviar" class="btn btn-info">Buscar</button>
...
while($row3=mysqli_fetch_array($rs1)){
   ...
   ?>           
          ...
          ?>
                 ...
                 <table class="table table-striped responsive-utilities jambo_table bulk_action" style="color:black;">
                    <thead>
                    ...
                    <tbody>
                     ...
                     <?php
                      ...
                      <tr class="even pointer">
                        ...
                        <td class=" ">Permiso para editar inventario </td>
                    ...
                    <tr class="even pointer">
                      ...
                      <td class=" ">Ventas de Productos</td>
                       ...
                       <tr >
                        ...
                        <td class=" ">Ventas de Productos</td>
                        <td class=" ">Ventas Fact/Bol/Nota de Venta </td>
                      ...
                      <tr>
                       ...
                       <tr >
                        ...
                        <td class=" ">Balance y otros</td>
                        <td class=" ">Balance de ventas y compras</td>
                       ...
                       <tr>
                        ...
                        <td class=" ">Tesoreria y Reportes</td>
