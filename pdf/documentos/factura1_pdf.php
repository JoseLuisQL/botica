...
while ($row=mysqli_fetch_array($sql))
	...
	?>
        ...
        <tr>
            <td class='<?php echo $clase;?>' style="width: 10%; text-align: center"><?php echo round($cantidad,2); ?></td>
            <td class='<?php echo $clase;?>' style="width: 60%; text-align: left"><?php echo $nombre_producto;?> <font color=red><?php echo $tipo8;?></font></td>
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_factura VALUES (NULL,'$id_proveedores','$id_vendedor','$numero_factura','2','$id_producto','$cantidad','$precio_venta_r','$c','1','2','$date_added','0','$tipo','$d','$moneda1','$folio','0','0','0','$tipo8','$tipo9')");
	...
	$insert_lote=mysqli_query($con,"INSERT INTO lote (id_producto,fec_vto,fec_fab,lote,tienda,inicial,final) VALUES ('$id_producto','$fec_vto','$fec_fab','$lote','$tienda','$cantidad7','$cantidad7')");
        $id_lote=mysqli_insert_id($con);
        $insert_lote1=mysqli_query($con, "INSERT INTO lote1 VALUES (NULL,'$id_lote','$date_added','$id_detalle','$cantidad7','0','2')");
        }
	...
	$total_factura=number_format($sumador_total/(1+iva),2,'.','');
        ...
        ?>  
        <tr>
            <td colspan="3" style="widtd: 85%; text-align: right;">OP GRAV <?php echo $mon;?> </td>
            <td style="widtd: 15%; text-align: right;"> <?php echo number_format($grav,2);?></td>
        </tr>
		<tr>
        	...
        	<tr>
            <td colspan="3" style="widtd: 85%; text-align: right;">EXONERADA <?php echo $mon;?></td>
            <td style="widtd: 15%; text-align: right;"> <?php echo number_format($exo,2);?></td>
        </tr>
...
//$fecha333='2018-11-11';
$sql3="select * from caja where tienda=$tienda and cierre=0 and usuario_inicio=$id_vendedor ORDER BY caja.id_caja DESC LIMIT 0 , 1";
...
$insert=mysqli_query($con,"INSERT INTO facturas VALUES (NULL,'$numero_factura','$date','0','','$id_proveedores','0','$id_vendedor','$condiciones','$sumador_total','$deuda','$tipo','$c','2','1','0','$moneda1','$cuenta','','0','2018-11-11','$dias','$folio','2','','0','','$tip','$turno')");
