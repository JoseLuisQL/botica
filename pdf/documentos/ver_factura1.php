...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, detalle_factura, facturas where detalle_factura.activo=1 and products.id_producto=detalle_factura.id_producto and facturas.ven_com=2 and facturas.estado_factura=detalle_factura.tipo_doc and detalle_factura.folio='$folio' and detalle_factura.fecha='$fecha' and detalle_factura.id_cliente=facturas.id_cliente and detalle_factura.numero_factura=facturas.numero_factura and facturas.id_factura='".$id_factura."' ORDER BY  `detalle_factura`.`id_detalle` ASC ");
while ($row=mysqli_fetch_array($sql))
	...
	?>
        <tr>
            ...
            <td class='<?php echo $clase;?>' style="width: 60%; text-align: left"><?php echo $nombre_producto;?> <?php echo $t7;?></td>
	...
	$total_factura=$subtotal/1.18;
        ...
        <tr>
            <td colspan="3" style="widtd: 85%; text-align: right;">GRAVADA <?PHP echo $mon;?> </td>
