...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_factura VALUES (NULL,'$id_proveedores','$id_vendedor','$numero_factura','2','$id_producto','$cantidad','$precio_venta_r','$c','1','2','$date_added','0','$tipo','$d','$moneda1','$folio','0','0')");
