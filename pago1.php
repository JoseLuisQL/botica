      ...
      <div class="right_col" role="main">
		  ...
		  <div class="modal-body" style="background: white;">
			...
			<div id="resultados_ajax2"></div>
				  ...
				  <input type="text" class="form-control" value="<?php echo $deuda1;?>" id="mod_deuda" name="mod_deuda" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-2">
                             <font color="red"  align="right"><strong>Deuda Documento <?php echo moneda;?></strong></font>
				</div>
                              <div class="col-md-3 col-sm-3 col-xs-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                 <input class="form-control" type="number" class="monto" style="background-color: white;width:170px;text-align:right;"  onkeyup="sumar();" value="<?php echo number_format($deuda1-$suma, 2, '.', '');?>" id="deuda<?php echo $i+1;?>" name="deuda<?php echo $i+1;?>" readonly>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
                                    <input class="form-control" type="number"  style="background-color: #F5D0A9;width:170px;text-align:right;" required autocomplete="off" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php echo $deuda1;?>';}" step="0.1" min="0" max="<?php echo $deuda1;?>" value="<?php echo $deuda1;?>" id="spTotal" name="spTotal" >
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				  <input class="form-control" type="text" style="background-color: #F5D0A9;" autocomplete="off" class="form-control" id="numero_factura" name="numero_factura" placeholder="Nro del documento" required>
				</div>
			  </div>
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
				 <select class="form-control" style="background-color: #F5D0A9;" id="estado_factura" name="estado_factura" required>
					...
					<select style="background-color: #F5D0A9;" class='form-control' id="condiciones" name="condiciones" required>
