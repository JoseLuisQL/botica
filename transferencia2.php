...
if($id>0 && $cantidad<=$inv_producto && $inv_producto>0 ){
    $consulta2 = "INSERT INTO detalle_factura
            values (NULL, '0','$usuario','0','1','$id','$cantidad','$precio','$tienda','1','1','$fecha1','$user_id','0','$inv_producto','0','0','0','0','0','0','0')";
    ...
    $consulta3 = "INSERT INTO detalle_factura
            values (NULL, '0','$usuario','0','2','$id','$cantidad','$precio','$tienda2','1','2','$fecha1','$user_id','0','$c','0','0','0','0','0','0','0')";
    ...
    header("location:transferencia.php?mensaje=No se pudo transferir error en el inventario");
}
ob_end_flush(); 
?>
